...
import { Card, CardBody, Input, Button, Switch, Divider, Tabs, Tab } from "@heroui/react";
            ...
            <CardBody className="p-4 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-foreground-500">Celsius o Fahrenheit</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-foreground-500">Cambia la apariencia de la aplicación</p>
                </div>
                <Switch 
                  isSelected={darkMode}
            ...
            <CardBody className="p-4 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-foreground-500">Recibe alertas en tu dispositivo</p>
                </div>
                <Switch 
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-foreground-500">Resumen diario del estado del acuario</p>
                </div>
                <Switch 
          ...
          <Card className="mt-4">
            <CardBody className="p-4 space-y-4">
              ...
              <p className="text-sm text-foreground-500 mb-4">
                Configura los rangos ideales para tu acuario. Recibirás alertas cuando los valores estén fuera de estos rangos.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="font-medium mb-2">Amonio (ppm)</p>
                  <div className="flex gap-2">
                    <Input
                      label="Máximo"
                      type="number"
                ...
                <div>
                  <p className="font-medium mb-2">Nitratos (ppm)</p>
                  <div className="flex gap-2">
                    <Input
                      label="Máximo"
                      type="number"
